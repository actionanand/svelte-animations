...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 7, 2, 109);
    			attr_dev(div, "class", "title-warap svelte-rz8rn2");
    			add_location(div, file, 6, 0, 81);
    			progress_1.value = /*$progress*/ ctx[1];
    			add_location(progress_1, file, 10, 0, 158);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, customProgress, $$value => $$invalidate(1, $progress = $$value));
    	...
    	$$self.$capture_state = () => ({ progress: customProgress, appName, $progress });
